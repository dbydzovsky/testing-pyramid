...
public class Button {
    ...
    public static Button findByText(WebDriverWrapper driver, String text) {
        WebElement webElement = driver.getWebDriver().findElement(By.xpath("//button[normalize-space()='" + text + "']"));
